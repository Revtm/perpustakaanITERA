...
public boolean tambahBuku(Connection con, buku Bukuu){
   String sql="INSERT INTO buku VALUES('"+Bukuu.getIsbn()+"','"+ LocalDate.now().toString() +"','"+Bukuu.getPenerbit()+"','"+Bukuu.getIdBuku()+"','"+Bukuu.getJudul()+"','"+Bukuu.getPosisi()+"','"+Bukuu.getStatus()+"','"+Bukuu.getPenulis()+"','"+Bukuu.getKategori()+"','" + Bukuu.getDeskripsi()+"');";
